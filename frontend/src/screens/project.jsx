...
` },
  ...
  return (
    <>
      ...
      <main className="h-screen overflow-hidden w-screen flex bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 ">
        {/* LEFT CHAT PANEL */}
        <section className="relative h-full w-1/4 min-w-[320px] flex flex-col bg-white/80 backdrop-blur-sm shadow-2xl border-r border-white/50">
          {/* Enhanced Header */}
